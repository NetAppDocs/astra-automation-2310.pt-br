...
summary: Crie um novo backend de armazenamento 
---
= Crie um novo backend de armazenamento
:allow-uri-read: 


[.api-doc-operation .api-doc-operation-post]#POST# [.api-doc-code-block]#`/accounts/{account_id}/topology/v1/storageBackends`#

Indica os valores desejados para o recurso da Storage Backend API a ser criado.
