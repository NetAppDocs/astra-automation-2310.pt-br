...
summary: Liste todas as credenciais 
---
= Liste todas as credenciais
:allow-uri-read: 
...
| itens | array[Qualquer um de: link:#credential_1_1_get_response_body["credencial_1.1_get_response_body"], array[]] | Verdadeiro  a| 
...
|===
[role="api-collapsible-fifth-title"]
credencial_1.1_get_response_body
