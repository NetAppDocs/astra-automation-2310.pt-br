...
summary: Liste todas as assinaturas 
---
...
| itens | array[Qualquer um de: link:#subscription_1_2_get_response_body["subscription_1.2_get_response_body"], array[]] | Verdadeiro  a| 
