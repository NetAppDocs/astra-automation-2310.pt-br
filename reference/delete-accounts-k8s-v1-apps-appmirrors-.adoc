...
summary: Excluir um recurso AppMirror de um aplicativo 
---
= Excluir um recurso AppMirror de um aplicativo
:allow-uri-read: 


[.api-doc-operation .api-doc-operation-delete]#EXCLUIR# [.api-doc-code-block]#`/accounts/{account_id}/k8s/v1/apps/{app_id}/appMirrors/{appMirror_id}`#
