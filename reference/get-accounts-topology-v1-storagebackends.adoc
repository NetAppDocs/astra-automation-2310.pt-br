...
summary: Liste todos os backends de armazenamento 
---
= Liste todos os backends de armazenamento
:allow-uri-read: 
...
| itens | array[Qualquer um de: link:#storageBackend_1_3_get_response_body["storageBackend_1.3_get_response_body"], array[]] | Verdadeiro  a| 
