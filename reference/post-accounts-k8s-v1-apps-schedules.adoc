...
summary: Criar um novo cronograma para um app 
---
= Criar um novo cronograma para um app
:allow-uri-read: 


[.api-doc-operation .api-doc-operation-post]#POST# [.api-doc-code-block]#`/accounts/{account_id}/k8s/v1/apps/{app_id}/schedules`#

Indica os valores desejados para o recurso da API Schedule a ser criado.
