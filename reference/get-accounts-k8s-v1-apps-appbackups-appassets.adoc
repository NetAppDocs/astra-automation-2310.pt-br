...
summary: Liste os recursos do aplicativo a partir de um backup do aplicativo para um app 
---
= Liste os recursos do aplicativo a partir de um backup do aplicativo para um app
:allow-uri-read: 
...
ID do recurso appBackup que o contém
