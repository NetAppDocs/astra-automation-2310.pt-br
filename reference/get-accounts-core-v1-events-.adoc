...
Retorna o recurso da API de Eventos armazenado no corpo da resposta JSON.
...
| id_do_evento | string | caminho | Verdadeiro  a| 
ID da coleção de eventos a ser listada
