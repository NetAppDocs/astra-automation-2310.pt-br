...
summary: Recuperar um recurso de aplicativo de um backup de aplicativo para um app 
---
= Recuperar um recurso de aplicativo de um backup de aplicativo para um app
:allow-uri-read: 
